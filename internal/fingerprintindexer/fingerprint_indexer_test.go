package fingerprintindexer_test
...
import (
	...
	"github.com/DIMO-Network/benthos-plugin/internal/fingerprintindexer"
...
func TestFingerprintIndexerProcessor(t *testing.T) {
	processor := &fingerprintindexer.Processor{}
	...
	tests := []struct {
		...
		{
			name: "Missing Time", // this test only works if the test is run in the same second as this declaration
			jsonString: `{
				"subject": "0xc57d6d57fca59d0517038c968a1b831b071fa679"
			}`,
			expectedMeta: mustEncode(&nameindexer.Index{
